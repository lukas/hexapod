...
- Robot Lab v2 (the experiment queue, loop and web/MCP service) lives in
  [lukas/hexapod-lab](https://github.com/lukas/hexapod-lab); it runs against a clone of this repo.
