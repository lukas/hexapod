#!/usr/bin/env python3
"""Re-demonstrate the exclusive command lease for THIS run (881677a0).
...
def call(base, path, body=None, method="POST", hdrs=None):
    req = urllib.request.Request(
        ...
        headers={"Content-Type": "application/json",
                 "X-Hexapod-Controller": "exclusivity-probe-881677a0",
...
code, body, ms = call(ROBOT, "/api/command-lease/acquire",
                      {"owner": OWNER, "ttl_s": 120,
                       "reason": "exclusivity demonstration for 881677a0"})
