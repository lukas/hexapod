...
# --- declared post-hoc: any measured non-L0 joint off logical zero > 1.0 deg
moving = {HIP_J, KNEE_J}
...
out = {
  ...
  "declared_posthoc_checks": {
    "measured_non_L0_joint_departure_gt_1p0_deg": {
      "bound_deg": 1.0,
      "worst": worst,
  ...
  "zero_variance_investigation": {
    "question": ("all six cycles report the same loop width; is that a real "
                 "quantized measurement or an analysis artifact?"),
...
print("non-L0 departure :", d["measured_non_L0_joint_departure_gt_1p0_deg"]["verdict"],
      "| worst", d["measured_non_L0_joint_departure_gt_1p0_deg"]["worst"])
...
print()
print("settled windows at the shared waypoint (hip q1_deg):")
