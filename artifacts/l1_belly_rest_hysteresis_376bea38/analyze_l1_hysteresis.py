#!/usr/bin/env python3
"""Per-cycle L1 hip hysteresis from the runner's own synchronized CSV.
...
3.1 s dwell, the same definition the L5 sibling run used, so the two legs are
directly comparable.
...
res = {
    ...
    "moving_leg": "L1", "hip_joint": HIP_J, "knee_joint": KNEE_J,
