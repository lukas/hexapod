...
## CORRECTION to the entry below: magnitude (done RIGHT) is actually the STRONGEST single lever found in the whole fprent/exploreresettle saga, not a dead end — `fprent-k0ctl-gentlestd`'s own flat-probe landed (2026-09-11 ~06:4x, standwalk track, triage cycle)
