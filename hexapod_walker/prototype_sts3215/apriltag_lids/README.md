...
## Additional tray, IDs 120–139

`out/tray_120-139/tag36h11_motor_lids_120-139_BambuStudio.3mf` contains
20 additional covers with the same servo-top geometry and white/black assignments.
These IDs were absent from the saved layouts and earlier print sets at generation.
Regenerate with `uv run python hexapod_walker/prototype_sts3215/apriltag_lids/make_apriltag_lids.py --ids 120-139 --output hexapod_walker/prototype_sts3215/apriltag_lids/out/tray_120-139`.

## H2D tray, IDs 120–151

`out/h2d_120-151/tag36h11_motor_lids_120-151_BambuStudio.3mf` has 32 covers
on one H2D plate, using the 0.4 mm standard nozzle profile and white/black PLA.
It retains IDs 120–139 and adds 140–151. All cover bounds fit the shared
dual-nozzle area (X=25–325, Y=0–320 mm). Bambu Studio CLI slicing passed,
and all 32 tag codes decoded correctly. Regenerate with `--ids 120-151
--printer h2d --output hexapod_walker/prototype_sts3215/apriltag_lids/out/h2d_120-151`.
