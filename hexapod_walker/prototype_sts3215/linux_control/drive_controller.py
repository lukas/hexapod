...
# linux_control itself. Promote paths even when already in PYTHONPATH:
# Python puts the script directory first, and older deployments may still
# contain flat-layout feetech_bus / motion_telemetry copies there.
