...
QUAD_VARIANTS = {
    ...
    "": ("rear", "walk", "trot", "cool"),
    "_pitch": ("rear_pitch", "walk_pitch", "trot_pitch", "rear-load"),
...
DEMOS = {
    ...
    "quad_rear_pitch": ("[8 quad] REAR LOAD — press rear supports, then hold", None),
    "quad_hold_pitch": ("[8 quad] HOLD REAR LOAD — settle on loaded supports", None),
    "quad_walk_pitch": ("[8 quad] WALK REAR LOAD — short steps while loaded", None),
    "quad_walk_back_pitch": ("[8 quad] WALK BACK REAR LOAD — reverse short steps", None),
    "quad_trot_pitch": ("[8 quad] TROT REAR LOAD — capped diagonal pairs", None),
    "quad_trot_back_pitch": ("[8 quad] TROT BACK REAR LOAD — capped diagonal pairs", None),
    "quad_down_pitch": ("[8 quad] COME DOWN REAR LOAD — exit loaded hold", None),
