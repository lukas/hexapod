# cap29-stdwalklohi-yawarm2p0-s1

<!-- GENERATED from experiments.json by launch_run.py — do not edit -->

**status**: REFUSED

**created**: 2026-09-03T22:15:45+00:00
...
**gate**: Same PASS/FAIL bar as the seed0 twin, read against the seed1 control (cap29-stdwalklo-hi-s1) instead.
