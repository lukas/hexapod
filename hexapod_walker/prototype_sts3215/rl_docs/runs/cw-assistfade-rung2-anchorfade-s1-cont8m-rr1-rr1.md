# cw-assistfade-rung2-anchorfade-s1-cont8m-rr1-rr1

<!-- GENERATED from experiments.json by launch_run.py — do not edit -->

**status**: REFUSED

**created**: 2026-09-06T11:35:46+00:00
...
**refused_reason**: config twin of RUNNING cw-assistfade-rung2-anchorfade-s1-cont8m (identical train args+steps; a seed twin would differ in --seed — pass --allow-twin only for a deliberate replica)
