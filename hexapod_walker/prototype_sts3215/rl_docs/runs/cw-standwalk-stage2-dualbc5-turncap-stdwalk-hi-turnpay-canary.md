...
**created**: 2026-08-31T07:42:34+00:00
...
**refused_reason**: hexapod-mjx-train-1 already runs cw-standwalk-stage2-dualbc5-turncap-stdwalk-mild-turnpay-canary — GPU pods host exactly one run; pick a free GPU pod.
