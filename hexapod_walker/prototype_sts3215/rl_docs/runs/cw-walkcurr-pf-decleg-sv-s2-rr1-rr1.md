# cw-walkcurr-pf-decleg-sv-s2-rr1-rr1

<!-- GENERATED from experiments.json by launch_run.py — do not edit -->

**status**: LAUNCH_CRASH

**created**: 2026-08-29T16:14:19+00:00
...
**verdict**: no ledger entry ever written (crashed before launch_run.py recorded intent); orphaned W&B run r2plquqa

**refused_reason**: W&B already has a run named cw-walkcurr-pf-decleg-sv-s2-rr1-rr1 (names are append-only; pick a new one)
