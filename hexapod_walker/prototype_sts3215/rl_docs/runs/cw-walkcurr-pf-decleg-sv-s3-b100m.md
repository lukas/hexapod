# cw-walkcurr-pf-decleg-sv-s3-b100m

<!-- GENERATED from experiments.json by launch_run.py — do not edit -->

**status**: FAIL

**created**: 2026-08-30T04:15:02+00:00
...
**verdict**: Same static-quiver-to-over_current basin as every other decleg-sv wave sibling (s0/s1/s2/s5, idle2). Auto health-stopped at 67.6M/100M steps (reward+survival+direction regressed together for 3 consecutive assays, composite 0.445) -- reward quarters [179.6,167.1,167.0,166.7] peak-early-then-flat, not rising, so this is NOT an 08-21 continue case. DR-0 gate n=24 all 4 sub-panels: prog med -0.00 to -0.09 (negative on det), slip/m med 4.4-5.2 (cap 3.0), gait_valid 0-1/6, 24/24 terminate via over_current, dir_err ~88deg (chance-level, not forward). Corrected discovery litmus unmet on all 3 legs: walk_speed 0.032 m/s barely off the 0.02 floor, ep_len_mean falling not rising (445, was higher pre-health-stop), over_current terminations climbing to 770/window not background. Video/contact sheet: static quiver, zero net translation, no six-leg gait. 2nd of 5 decleg-b100m population-sweep arms read (s5 already FAIL'd this basin; s2/s4/s6 pending sibling cycles) -- population/budget lever closing for decleg architecture at 100M, matching the track's pre-registered fallback: if all 5 fail, structural anti-freeze/balance pretrain curriculum becomes the only untried lever.
