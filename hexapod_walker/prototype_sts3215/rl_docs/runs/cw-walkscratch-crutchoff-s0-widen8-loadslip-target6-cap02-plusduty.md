# cw-walkscratch-crutchoff-s0-widen8-loadslip-target6-cap02-plusduty

<!-- GENERATED from experiments.json by launch_run.py — do not edit -->

**status**: REFUSED

**created**: 2026-09-08T19:23:29+00:00
...
**refused_reason**: hexapod-mjx-train-0 code marker 6cd5f7b44f204048fbb96fe181298dd0ca6be020-dirty != local HEAD 6cd5f7b44f204048fbb96fe181298dd0ca6be020 and the delta is not benign-orchestrator-only. Sync first: snapshot.sh --sync hexapod-mjx-train-0 (and snapshot/commit before that if the tree is dirty).
