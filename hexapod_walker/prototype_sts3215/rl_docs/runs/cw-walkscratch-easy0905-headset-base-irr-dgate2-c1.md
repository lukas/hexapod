...
**created**: 2026-09-05T17:38:44+00:00
...
**refused_reason**: hexapod-mjx-train-4 already runs cw-walkscratch-easy0905-headset-base-irr-dgate2-c1 — GPU pods host exactly one run; pick a free GPU pod.
