# cw-walkscratch-easy0905-headset-crossgrav-medhead-dr-allaxis-nokick-crutchoff-s1-speedwiden

<!-- GENERATED from experiments.json by launch_run.py — do not edit -->

**status**: CANARY PASS

**created**: 2026-09-07T09:18:43+00:00
...
**verdict**: CANARY PASS: speed-range widening composes cleanly, 2nd seed. Evidence: 24/24 episodes, gait_valid 21/24, 0 terminations -- essentially identical to this seed's own s1-acq1 baseline (21/24 gv, 0 terms), sac confined to walk_startjitter/sto leg0/leg5, exactly the parent's pre-existing signature. Why: clean composable pass, zero drift from baseline. Next: license the ACQ (40M) continuation.
