...
**verdict**: Matched control PASSES its own retention gate at 10M cumulative: gait_valid 22/24 (6/5/5/6 across walk-det/sto/startjitter-det/sto), 0 falls/terms in 24/24, slip/m median 5.09/5.32/5.29/5.77 -- squarely inside the ~5-6/m source band, no new chronic single-leg sacrifice. Train reward rose steadily the whole continuation (quarters 288 -> 847 -> 1503 -> 1771), the normal retention shape. This is the valid comparison band for the cartfoot-c1-cont10m mechanism read; the control itself did not drift.
