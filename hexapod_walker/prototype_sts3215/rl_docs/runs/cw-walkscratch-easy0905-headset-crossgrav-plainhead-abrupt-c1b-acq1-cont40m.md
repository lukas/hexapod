...
**verdict**: HARDENING PASS/HOLDS: +40M (80M cumulative) on the simplest un-composed crossgrav champion (plainhead-abrupt-c1b) holds flat at 23/24 gait_valid vs its own 40M parent's 23/24, 0 falls/terminations either side. The single flagged leg (leg4) just relocated: parent's isolated flag was walk_startjitter/det ep5, which clears (5/6->6/6) at 80M while a new single-episode leg4 flag appears in walk/det ep0 (6/6->5/6) -- still exactly one flagged episode total, never the same mode-episode twice, no chronic consolidation. walk/sto and walk_startjitter/sto stay perfect 6/6 both budgets. Reward rising every quarter (806.4/1447.5/1602.0/1735.9). 2nd un-composed-source confirmation that endurance tolerance tracks 40M cleanliness margin. Evidence: logs/ckpt_eval/cw_walkscratch_easy0905_headset_crossgrav_plainhead_abrupt_c1b_acq1_cont40m_gate/report.json vs ..._acq1_gate/report.json, W&B ffw6vzlu.
