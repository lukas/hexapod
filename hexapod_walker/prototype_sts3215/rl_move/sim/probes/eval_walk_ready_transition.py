...
all-six-leg glide baseline.
    ...
    uv run --active python -m rl_move.sim.probes.eval_walk_ready_transition
    uv run --active python -m rl_move.sim.probes.eval_walk_ready_transition --json
"""
...
for p in (_ROOT, _ROOT / "linux_control", _ROOT.parent):
    if str(p) not in sys.path:
        sys.path.insert(0, str(p))

from hexapod_core.walk_ready_transition import (  # noqa: E402
