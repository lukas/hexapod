...
from .balance_helpers import (
    PLANT_SPEC, _load_robot_abs_q_npz, action_rate_penalty,
    current_headroom_income_factor, footprint_fade, footprint_rent_m,
    load_rise_ref, lower_depth_frac, support_margin_m,
    torque_headroom_debt_step, valid_plant,
)
...
class SimHexapodBalanceEnv(_GymBase):
    ...
    def _reset_begin(self, seed: int | None = None) -> np.ndarray:
        ...
        _e_g_dr_lo = cfg_get(self.cfg, "ease", "gravity_scale_dr_lo",
                             default=None)
        _e_g_dr_hi = cfg_get(self.cfg, "ease", "gravity_scale_dr_hi",
                             default=None)
        if _e_g_dr_lo is not None or _e_g_dr_hi is not None:
            ...
            _e_g = (float(self.rng.uniform(_e_g_dr_lo, _e_g_dr_hi))
