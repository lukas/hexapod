...
lengths taken from ``motor_setup/wire_harness_plan.py`` — then invokes
    ...
    return {
        "metadata": {
            ...
            "description": (
                ...
                "motor_setup/wire_harness_plan.py (per-leg branch lengths). "
...
def main() -> None:
    ...
    header = (
        ...
        "motor_setup/wire_harness_plan.py.\n"
    )
